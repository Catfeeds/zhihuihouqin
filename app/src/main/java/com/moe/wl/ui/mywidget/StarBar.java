...
/**
 * Created by 我的电脑 on 2017/11/10 0010.
 */
...
public class StarBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.starDistance = (int) mTypedArray.getDimension(R.styleable.RatingBars_starDistance, 0);
        this.starSize = (int) mTypedArray.getDimension(R.styleable.RatingBars_starSize, 20);
        this.starCount = mTypedArray.getInteger(R.styleable.RatingBars_starCounts, 5);
        this.starEmptyDrawable = mTypedArray.getDrawable(R.styleable.RatingBars_starEmptys);
        this.starFillBitmap = drawableToBitmap(mTypedArray.getDrawable(R.styleable.RatingBars_starFills));
        mTypedArray.recycle();
