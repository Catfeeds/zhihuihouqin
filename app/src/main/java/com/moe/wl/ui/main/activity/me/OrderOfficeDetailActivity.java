...
public class OrderOfficeDetailActivity extends MyBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_office_detail);
...
//        delivery.setText("配送服务：" + data.get);
                ...
                .setPositiveButton("是", new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (state == 1) {
                            ...
                            CallPhoneUtils.callPhone(mobile, OrderOfficeDetailActivity.this);
                        }
                    }
                })
    ...
    private void getData(int orderID) {
        Observable observable = RetrofitUtils.getInstance().orderOfficeDetail(orderID);
        showProgressDialog();
        observable.subscribe(new Subscriber<OrderOfficeDetailBean>() {
            @Override
            ...
            @Override
            public void onNext(OrderOfficeDetailBean orderBean) {
