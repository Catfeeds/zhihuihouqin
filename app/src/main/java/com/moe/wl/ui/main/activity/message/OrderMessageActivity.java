 ...
 */
public class OrderMessageActivity extends MessageActivity {
    ...
    private int page = 1;
    private int messageType = 6; // 消息类型 请求接口做为参数
    ...
    public void initView() {
        ...
        adapter.setOnItemClickListener(new SystemMessageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                Intent intent = new Intent(OrderMessageActivity.this, MessageDetailActivity.class);
