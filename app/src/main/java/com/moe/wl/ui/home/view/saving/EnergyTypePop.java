...
public class EnergyTypePop extends PopupWindow {

    private View conentView;
    private ListView lv_content;

    private MenuPopwindow.MyOnClick click;
    private Activity context;
    private String[] strings;


    public EnergyTypePop(Activity context,String[] strings, MenuPopwindow.MyOnClick click) {
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        conentView = inflater.inflate(R.layout.menu_popup1_window, null);
        this.click=click;
