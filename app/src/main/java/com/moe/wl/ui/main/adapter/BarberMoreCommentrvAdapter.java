...
public class BarberMoreCommentrvAdapter extends RecyclerView.Adapter {

    private  List<BarberMoreCommentBean.CommentlistBean> list;
    private Context mContext;


    public BarberMoreCommentrvAdapter(MoreUSerCommentActivity context, List<BarberMoreCommentBean.CommentlistBean> data) {
