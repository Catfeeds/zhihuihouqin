 ...
 * 用水统计
 */
public class WaterStatistcsFragment extends BaseFragment<ElectroModel, ElectroView, ElectroPresenter> implements ElectroView {
...
//    LinearLayout llBuildNum;
    ...
    public void initView(View v) {
        ...
        getPresenter().getDetail(curYear+"", dateType, 2, buildId);
        //初始化设置
    ...
    public void setType(String time, int  unit,int bid) {
        ...
        getPresenter().getDetail(selectTime, unit, 2, buildId);
    }
    ...
    public void getInfo(EnergyCostQueryBean bean) {
        if(bean!=null){
            ...
            tvWater.setText(energyTotal.getEnergyCost()+"");
        }
    }
}
