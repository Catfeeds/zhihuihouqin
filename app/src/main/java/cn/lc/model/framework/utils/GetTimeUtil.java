...
//        System.out.println(brith_StrTime);
	...
	//
//	public static String long3HHmm(long time){
//		String brith_StrTime = null;
//		SimpleDateFormat sdf = null;
//		sdf = new SimpleDateFormat("HH:mm");
//		brith_StrTime = sdf.format(new Date(time * 1000L));
//		if (Integer.parseInt(brith_StrTime)>=12){
//
//		}
//		return null;
//	}
	...
	public static String getYMDTimeR(long time) {
		String brith_StrTime_Sub = null;
		String brith_StrTime = null;
		SimpleDateFormat sdf = null;
		sdf = new SimpleDateFormat("yyyy年MM月dd日");
		brith_StrTime = sdf.format(new Date(time));
		brith_StrTime_Sub = brith_StrTime.substring(5);
		return brith_StrTime_Sub;
	}
