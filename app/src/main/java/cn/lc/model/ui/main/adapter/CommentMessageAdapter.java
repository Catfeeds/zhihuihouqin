...
public class CommentMessageAdapter extends RecyclerView.Adapter {
    ...
    public CommentMessageAdapter(Context context, List<MessageListBean.PageEntity.ListEntity> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_comment_message, null);
